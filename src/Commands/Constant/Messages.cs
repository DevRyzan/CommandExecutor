...
public static class Messages
{
    ...
    public const string RandAddMessage = "4. randadd - Adds a random value to the result";
    public const string UndoMessage = "5. undo - Undo the last command";
    public const string Exit = "6. exit - Close the App";
